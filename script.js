...
async function getQuiz() {
    ...
    for (let k = 0; k < optionDiv.length; k++) {
        ...
        class="option py-2 bg-transparent text-red-600 font-semibold border border-red-600 rounded hover:bg-red-600 hover:text-white hover:border-transparent transition ease-in duration-200 transform hover:-translate-y-1 active:translate-y-0 m-2 px-8 overflow-auto" >
        Loading...
    </button>`        
    }
...
$(".result").click(function (e) { 
    e.preventDefault();
    getQuiz()
    $(".lightthisup").addClass("blur-out-expand");
